...
"""
# Chat GPT 2:
# Hexagon is spinning, Ball is bouncing.But after few bounces it drops slowly out of sight
...
# Function to check ball-wall collision and bounce
def handle_ball_collision(ball_pos, ball_vel, hexagon_points, center):
    for i in range(6):
        ...
        # Compute vector from wall to ball
        ball_to_wall = (ball_pos[0] - a[0], ball_pos[1] - a[1])
        dot_product = ball_to_wall[0] * wall_normal[0] + ball_to_wall[1] * wall_normal[1]
...
while running:
    ...
    # Handle collision
    handle_ball_collision(ball_pos, ball_vel, hexagon_points, (WIDTH // 2, HEIGHT // 2))
